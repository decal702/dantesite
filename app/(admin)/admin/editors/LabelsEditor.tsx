...
type LabelKey = "eyebrow" | "title" | "intro";
...
const SECTION_DESCRIPTORS: Array<{
  ...
  { key: "about", label: "About section", fields: ["eyebrow", "title"] },
  {
    key: "services",
  ...
  { key: "testimonials", label: "Reviews section", fields: ["title"] },
  {
    key: "faq",
    label: "FAQ section",
    fields: ["eyebrow", "title", "intro"],
...
export default function LabelsEditor({
  ...
  function patchField(
    ...
    const next: SectionLabels = { ...data[sectionKey], [field]: value };
    onChange({ ...data, [sectionKey]: next });
  }
          ...
          >
            ...
            {descriptor.fields.map((field) => (
              <BilingualField
                ...
                value={data[descriptor.key][field] ?? EMPTY_BILINGUAL}
                onChange={(value) => patchField(descriptor.key, field, value)}
